		...
		<section>
				<div>
						<img style="object-fit: contain !important; object-position: center !important; width: 100%"
								src="{{ asset('assets/images/about/blimotomock.png') }}" alt="Genone Mock Image" />
				</div>
		</section>
				...
				<div class="container-fluid px-md-5 px-2">
								...
								<div class="col-12 col-md-12 col-lg-6">
										<div class="welcome-item" style="margin-top: -5rem;">
												<div class="welcome-wrapper p-5">
														<h2>Gen One</h2>
														<h3>Selamat datang di Genone Official !</h3>
														<p>
																Sebuah platform yang mempermudah anda dalam mencari informasi terkait harga, angsuran hingga diskon yang
																sesungguhnya dari sebuah produk kendaraan yang sedang anda cari. Genone menyediakan fitur yang membuat
																anda
																...
																karena Gen One memberikan cara yang asik buat kalian untuk membeli motor.
														</p>
												</div>
										</div>
								</div>
												...
												<div class="row">
														<div class="col-12 col-md-6 p-2">
																<div class="rounded-lg p-4" style="border: 1px solid #D22232; background-color: #FFF6F7;">
																		...
																		<p class="text-black">Nikmati penawaran diskon eksklusif untuk motor impianmu di Gen One!</p>
														...
														<div class="col-12 col-md-6 p-2">
																<div class="rounded-lg p-4" style="border: 1px solid #01E928; background-color: #E3FFE8;">
																		...
																		<p class="text-black">Miliki motor impian dengan DP terjangkau hanya di Gen One!</p>
														...
														<div class="col-12 col-md-6 p-2">
																<div class="rounded-lg p-4" style="border: 1px solid #FC0; background-color: #FFFAE4;">
																		...
																		<p class="text-black">Temukan harga terbaik untuk motor pilihanmu hanya di Gen One!</p>
														...
														<div class="col-12 col-md-6 p-2">
																<div class="rounded-lg p-4" style="border: 1px solid #9747FF; background-color: #FFEDFF;">
																		...
																		<p class="text-black">Nikmati angsuran ringan untuk memudahkan kepemilikan motor di Gen One!</p>
						...
						<div class="row mt-5">
								<div class="col-12">
										...
										<p class="about-text text-black">Gen One diluncurkan pada tanggal 2 Mei 2024 dengan tujuan untuk
												memberikan
						...
						<div class="row mt-5 py-5">
								<div class="col-12">
										...
										<div class="about-text mb-3 text-black">
												...
												<span>support@genoneofficial.com</span>
										</div>
