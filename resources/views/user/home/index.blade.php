...
@section('content')
		...
		<section class="section-review">
				<div class="container-fluid padding-primary">
						<div class="row mb-3">
								<div class="col-11 col-md-10 px-3 py-3">
										<p class="fs-4 fw-bold mb-1 text-start text-black">Video Dari Genone</p>
								</div>
								<div class="col-12">
										@php
								...
								<div class="row">
										<div class="col">
												<div class="banner-contain">
														...
														<!-- <h3>food market</h3> -->
														<!-- <h4>special offer</h4> -->
														<a href="https://wa.me/6281369374541?text=halo%20admin%20,%20saya%20ingin%20informasi%20cara%20pengajuan%20kredit%20di%20blimoto"
